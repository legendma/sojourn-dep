...
private:
    ...
    void _register_member(lua_State *state,
        ...
        _funs.emplace_back(
            Selene::make_unique<ClassFun<1, T, M>>(
        ...
        _funs.emplace_back(
            Selene::make_unique<ClassFun<0, T, void, M>>(
    ...
    void _register_member(lua_State *state,
        ...
        _funs.emplace_back(
            Selene::make_unique<ClassFun<arity, T, Ret, Args...>>(
    ...
    void _register_member(lua_State *state,
        ...
        constexpr int arity = detail::_arity<Ret>::value;
        _funs.emplace_back(
            Selene::make_unique<ClassFun<arity, const T, Ret, Args...>>(
                state, std::string(fun_name),
                _metatable_name.c_str(), lambda));
    }
